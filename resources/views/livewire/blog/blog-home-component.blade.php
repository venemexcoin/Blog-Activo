<section class="blog-list px-3 py-5 p-md-5">
    <div class="container">
        <div class="item mb-5">
            <div class="media">
                <img class="mr-3 img-fluid post-thumb d-none d-md-flex"
                    src="{{ asset('assets/blog/images/blog/blog-post-thumb-1.jpg') }}" alt="image">
        ...
        <div class="item mb-5">
            <div class="media">
                <img class="mr-3 img-fluid post-thumb d-none d-md-flex"
                    src="{{ asset('assets/blog/images/blog/blog-post-thumb-2.jpg') }}" alt="image">
                <div class="media-body">
        ...
        <div class="item mb-5">
            <div class="media">
                <img class="mr-3 img-fluid post-thumb d-none d-md-flex"
                    src="{{ asset('assets/blog/images/blog/blog-post-thumb-3.jpg') }}" alt="image">
                <div class="media-body">
        ...
        <div class="item mb-5">
            <div class="media">
                <img class="mr-3 img-fluid post-thumb d-none d-md-flex"
                    src="{{ asset('assets/blog/images/blog/blog-post-thumb-4.jpg') }}" alt="image">
                <div class="media-body">
        ...
        <div class="item mb-5">
            <div class="media">
                <img class="mr-3 img-fluid post-thumb d-none d-md-flex"
                    src="{{ asset('assets/blog/images/blog/blog-post-thumb-5.jpg') }}" alt="image">
                <div class="media-body">
        ...
        <div class="item">
            <div class="media">
                <img class="mr-3 img-fluid post-thumb d-none d-md-flex"
                    src="{{ asset('assets/blog/images/blog/blog-post-thumb-6.jpg') }}" alt="image">
                <div class="media-body">
